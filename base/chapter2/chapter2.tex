\section*{UMAP reveals cryptic population structure and phenotype heterogeneity in large genomic cohorts}
...
$^2$McGill University and Genome Quebec Innovation Centre, Montreal, Qu\'{e}bec, Canada  \\
$^3$Department of Human Genetics, McGill University, Montreal, Qu\'{e}bec, Canada}

* Corresponding author: simon.gravel@mcgill.ca

Published in \textit{PLoS Genetics} 15.11 (2019): e1008432.
...
\begin{figure}[ht]
    ...
    \includegraphics[width=0.7\textwidth]{base/chapter2/figures/fig1.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{{base/chapter2/figures/fig2.png}}
...
\includegraphics[width=\columnwidth]{base/chapter2/figures/UKBB_PC0_PC1_eth_crop.jpeg}
    %\includegraphics[width=\columnwidth]{placeholder.png}
\caption{}%
\label{fig:pc_ukbb}%
\end{subfigure}\hfill%
\begin{subfigure}{.5\columnwidth}
\includegraphics[width=\columnwidth]{base/chapter2/figures/UKBB_UMAP_PC10_NN15_MD05_eth_labels.jpeg}%
    %\includegraphics[width=\columnwidth]{placeholder.png}
\caption{}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\columnwidth]{base/chapter2/figures/UKBB_UMAP_PC10_NN15_MD05_2018328174511_geo_permuted_10nn_sd50000_base50000_201883118582.pdf}
...
\begin{figure}[h!]
  ...
  \begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{base/chapter2/figures/UKBB_mapsInMaps_2D3_permute50.jpg}
        %\includegraphics[width=\columnwidth]{placeholder.png}
    \caption{}
    \label{fig:umap_ukbb_geo_map}
  \end{subfigure}
  \begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{base/chapter2/figures/meanWorldMap.jpg}
    %\includegraphics[width=\columnwidth]{placeholder.png}
    \caption{}
...
%    \includegraphics[width=0.8\columnwidth]{images/UKBB_UMAP_PC10_NN15_MD05_2018328174511_geo_permuted_10nn_sd50000_base50000_201883118582.pdf}
    \includegraphics[width=0.8\columnwidth]{base/chapter2/figures/fig6.png}
...
\input{base/chapter2/chapter2_supp.tex}
