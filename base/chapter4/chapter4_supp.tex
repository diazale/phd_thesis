...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.45\linewidth}
    \includegraphics[width=\linewidth]{base/chapter4/figures/selected_clusters_labelled_COB.png}
        %\includegraphics[width=\linewidth]{placeholder.png}
    \caption{}
    \label{fig:supp_ukb_hdbscan_top1}
  \end{subfigure}
  \begin{subfigure}[b]{0.45\linewidth}
    \includegraphics[width=\linewidth]{base/chapter4/figures/selected_clusters_labelled_eth.png}
        %\includegraphics[width=\linewidth]{placeholder.png}
    \caption{}
...
\begin{figure}[ht]
  \centering
    \includegraphics[width=0.8\linewidth]{base/chapter4/figures/admixture_tall_5.png}
...
\begin{figure}[ht]
  \centering
    \includegraphics[width=0.9\linewidth]{base/chapter4/figures/daily_smoking_proportion.jpeg}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.7\linewidth}
    \includegraphics[width=\linewidth]{base/chapter4/figures/SR4_FEV1_ridge_prepc.jpeg}
    %\includegraphics[width=\linewidth]{placeholder.png}
    \caption{}
    \label{fig:supp_pheno_ridge_fev_pre}
  \end{subfigure}
    \begin{subfigure}[b]{0.7\linewidth}
    \includegraphics[width=\linewidth]{base/chapter4/figures/SR4_FEV1_ridge_postpc.jpeg}
%\includegraphics[width=\linewidth]{placeholder.png}
    \caption{}
...
\begin{figure}[ht]
  \centering
  \begin{subfigure}[b]{0.7\linewidth}
    \includegraphics[width=\linewidth]{base/chapter4/figures/SR4_X30140_Neutrophill_count_ridge_prepc.jpeg}
    %\includegraphics[width=\linewidth]{placeholder.png}
    \caption{}
    \label{fig:supp_pheno_ridge_neut_pre}
  \end{subfigure}
    \begin{subfigure}[b]{0.7\linewidth}
    \includegraphics[width=\linewidth]{base/chapter4/figures/SR4_X30140_Neutrophill_count_ridge_postpc.jpeg}
    %\includegraphics[width=\linewidth]{placeholder.png}
    \caption{}
...
\begin{figure}[ht]
  \centering
    \includegraphics[width=0.9\linewidth]{base/chapter4/figures/pca_cluster_22_20200214_065646_2.png}
    %\includegraphics[width=0.9\linewidth]{placeholder.png}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.9\linewidth]{base/chapter4/figures/LDL_median_r2_vs_maf_rs4420638.png}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.9\linewidth]{base/chapter4/figures/LDL_median_r2_vs_maf_rs7412.png}
    %\includegraphics[width=0.4\linewidth]{placeholder.png}
...
\begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{base/chapter4/figures/num_unclustered.png}
    %\includegraphics[width=\linewidth]{placeholder.png}
    \caption{}
    \label{fig:supp_num_unclustered_1}
  \end{subfigure}
  \begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{base/chapter4/figures/num_unclustered_filtered.png}
    %\includegraphics[width=\linewidth]{placeholder.png}
    \caption{}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.7\linewidth]{base/chapter4/figures/hdbscan_labels_min25_EPS05_ukbb_pca_with_ids_UMAP_PC25_NC5_NN5_MD00_euclidean_20200215_162944.png}
%\includegraphics[width=0.7\linewidth]{placeholder.png}
