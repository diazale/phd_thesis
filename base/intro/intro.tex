...
Their population structure, however, is extraordinarily complex and not known in advance. The demographic history of every region influences its population structure; even limiting a biobank to one city requires an in-depth knowledge of its history: indigenous structure, migrations, admixture, 

a panacea can quickly transform into a witch's brew of statistical biases

there is a witch's brew of 
...
\citep{martin_human_2017}

Pervasive selection bias in the UKB
