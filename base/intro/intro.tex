...
\begin{subfigure}{.5\columnwidth}
    ...
    \label{fig:tree}
\end{subfigure}
\caption[Density clustering]{\textbf{Density clustering.} A density function $p$. \textbf{(a)} Density clusters corresponding to $L_{t}~=~\{x:~p(x)~>~t\}$. \textbf{(b)} The density tree. }
