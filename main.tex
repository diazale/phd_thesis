...
\chapter*{Chapter 3: A review of UMAP in population genetics}
\label{chap:chapter2}
...
\chapter*{Chapter 4: Topological stratification of continuous genetic variation in large biobanks}
\label{chap:chapter3}
